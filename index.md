...
## 📄 Профиль
Имею опыт работы с аналитическими исследовательскими проектами: от выявления задач и потребностей заказчика до анализа данных, подготовки выводов и разработки рекомендаций. Умею структурировать информацию, работать с количественными и текстовыми данными, формулировать и презентовать результаты.

Хочу далее развиваться в направлении бизнес-анализа, интересуюсь задачами, связанными с анализом и оптимизацией бизнес-процессов, продуктов и принятия решений на основе данных. Готов быстро осваивать новые инструменты и подходы и применять их на практике.  
...
- **НИУ ВШЭ,** *2022-2026* — PhD в области социологии  
